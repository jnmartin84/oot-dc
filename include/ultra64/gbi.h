...
#ifdef __DREAMCAST__
/*
 * On Dreamcast, Mtx is just floats - no fixed-point conversion needed.
 */
typedef f32 __attribute__((aligned(32))) Mtx_t[4][4];
typedef union __attribute__((aligned(32))) Mtx {
    Mtx_t   m;
    long long int force_structure_alignment;
} Mtx;
