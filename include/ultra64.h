...
#include <stdio.h>
#define sqrtf shz_sqrtf
#define fabsf shz_fabsf
#define floorf shz_floorf
#define ceilf shz_ceilf
#define fmodf shz_fmodf
#define cosf shz_cosf
#define sinf shz_sinf
...
#else
// Asset build - no arch needed, dummy assert
