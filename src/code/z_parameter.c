...
#ifdef __DREAMCAST__
    gfx_texture_cache_invalidate(interfaceCtx->iconItemSegment + (button * ITEM_ICON_SIZE));
#endif
}
...
//    printf("interfaceCtx->actionVtx[0].z %d translate %f\n", interfaceCtx->actionVtx[0].v.ob[2], XREG(18) / 10.0f);
